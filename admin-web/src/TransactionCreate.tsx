        ...
        reader.onload = async () => {
          try {
            ...
            if (result.data.success) {
              ...
              setFormData(prev => ({ ...prev, amount: data.amount ? data.amount.toLocaleString() : prev.amount, merchantName: data.merchantName || prev.merchantName, transactionDate: data.date || prev.transactionDate }));
              alert('領収書を自動認識しました！');
